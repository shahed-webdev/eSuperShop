            ...
            <div v-for="(item,i) in data" :key="i" class="col-lg-4 col-sm-6 mb-3">
                <a :href="'/'+item.StoreSlugUrl">
                    <div class="card hoverable card-body">
                        ...
                        <div class="photo-box">
                            <div v-for="(fileName, i) in item.ProductImageFileNames" :key="i" class="box">
                                <img :src="baseUrl+'/thumb_'+fileName" alt="" />
                            </div>
                        </div>
                    </div>
                </a>
...
<script>
    ...
    export default {
        ...
        methods: {
            getData() {
                axios.get('/home/GetTopStore', { params: { Page: 1, PageSize: 6 } }).then(response => {
