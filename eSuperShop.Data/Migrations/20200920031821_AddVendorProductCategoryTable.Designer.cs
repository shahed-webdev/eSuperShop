...
namespace eSuperShop.Data.Migrations
{
    ...
    [Migration("20200920031821_AddVendorProductCategoryTable")]
    partial class AddVendorProductCategoryTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eSuperShop.Data.ProductAttributeSet", b =>
                {
                    b.Property<int>("ProductAttributeSetId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("ProductAttributeSetId");

                    b.HasIndex("ProductId");

                    b.ToTable("ProductAttributeSet");
                });

            modelBuilder.Entity("eSuperShop.Data.ProductAttributeSetList", b =>
                {
                    b.Property<int>("ProductAttributeSetListId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("ProductAttributeSetListId");

                    b.HasIndex("ProductAttributeId");

                    b.HasIndex("ProductAttributeSetId");

                    b.ToTable("ProductAttributeSetList");
                });
            ...
            modelBuilder.Entity("eSuperShop.Data.Vendor", b =>
                {
                    ...
                    b.Property<string>("StoreBanarUrl")
                        .HasColumnType("nvarchar(255)")
                        .HasMaxLength(255);
            ...
            modelBuilder.Entity("eSuperShop.Data.ProductAttributeSetList", b =>
                {
                    b.HasOne("eSuperShop.Data.ProductAttribute", "ProductAttribute")
                        .WithMany("ProductAttributeSetList")
                        .HasForeignKey("ProductAttributeId")
                        .HasConstraintName("FK_ProductAttributeSetList_ProductAttribute")
                        .OnDelete(DeleteBehavior.ClientNoAction)
                        .IsRequired();

                    b.HasOne("eSuperShop.Data.ProductAttributeSet", "ProductAttributeSet")
                        .WithMany("ProductAttributeSetList")
                        .HasForeignKey("ProductAttributeSetId")
